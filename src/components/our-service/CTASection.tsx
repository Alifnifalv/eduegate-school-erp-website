        ...
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div className="relative p-8 md:p-12 lg:p-16 text-center z-10">
            ...
            <p className="text-base md:text-lg text-blue-100 max-w-2xl mx-auto mb-8 leading-relaxed">
              Request a personalized demo and implementation plan. Our team will help you understand how Eduegate can streamline your operations and enhance student learning outcomes.
            </p>
