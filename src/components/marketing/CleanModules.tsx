    ...
    <section className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold font-sans tracking-tight text-gray-900 sm:text-4xl">
            eduêgate ERP – Modular, Scalable, School-Ready
          </h2>
          <p className="mt-6 max-w-3xl mx-auto text-lg font-serif leading-8 text-gray-600">
          ...
          {modules.map((module) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mt-4 font-bold font-sans text-lg text-gray-900">{module.title}</h3>
                <p className="mt-2 text-sm font-serif text-gray-600 leading-relaxed">
                  {module.description}
                </p>
              </div>
            </div>
