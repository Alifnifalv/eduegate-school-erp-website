    ...
    <section className="relative border-b border-gray-200 bg-gray-50/50 py-16 lg:py-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute z-20 flex items-center justify-center size-36 rounded-2xl border border-gray-200 bg-white/30 shadow-2xl backdrop-blur-sm">
         <Image src="/logos/mini-logo.svg" alt="Logo" width={80} height={80} />
         </div>

           {/* Orbiting Logos - Marquee Effect */}
           {/* Note: This is a simplified version of the orbit. A true orbit requires more complex CSS. */}
...
// // src/components/marketing/NewHeroSection.tsx
// import { Quote } from 'lucide-react';
// import Image from 'next/image';
...
//             <Quote className="size-6 absolute -top-3 right-4 fill-white stroke-white drop-shadow-lg" />
//             <p className="text-base text-gray-600">
//               Hands down <span className="text-gray-900 font-semibold">the most developer friendly package</span> that I have worked with. <span className="text-gray-900 font-semibold">A++++</span>
//             </p>
//             <div className="flex flex-col sm:flex-row items-baseline justify-between gap-2.5">
//               <span className="text-sm text-gray-900 font-semibold">Levon Dzavahyan</span>
//               <span className="text-xs">
//                 <span className="text-gray-500">Chief Software Architect at </span>
//                 <span className="text-gray-900 font-semibold">solarspace.io</span>
//               </span>
//             </div>
//           </div>
...
//             <div>
//               <div className="flex items-center gap-1 text-yellow-400">★★★★★</div>
//               <span className="font-semibold text-sm text-gray-800">118,000+ Devs & Founders</span>
//             </div>
//           </div>
//         </div>

//         {/* Right Column (Animated Logo Cloud) */}
//         <div className="hidden lg:flex items-center justify-center h-[500px] w-full relative">
//           {/* Central Logo */}
//           <div className="absolute z-20 flex items-center justify-center size-36 rounded-2xl border border-gray-200 bg-white/30 shadow-2xl backdrop-blur-sm">
//             <Image src="/logos/mini-logo.svg" alt="Logo" width={80} height={80} />
