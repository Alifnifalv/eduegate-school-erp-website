        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <motion.div  initial="hidden"
            ...
            <div className="space-y-2">
              <motion.h1 variants={fadeInUp} className="text-3xl md:text-5xl font-bold font-lato leading-tight">
              ...
              <motion.h2 variants={fadeInUp} className="text-lg lg:text-3xl font-semibold font-lato text-gray-800">
            ...
            <motion.div variants={fadeInUp} className="rounded-xl bg-white shadow-lg border border-gray-200/80 p-5 space-y-3.5 relative w-full max-w-md">
              ...
              <div className="flex flex-col sm:flex-row items-baseline justify-between gap-2.5">
                <span className="text-sm font-roboto text-gray-900 font-semibold">John Doe</span>
