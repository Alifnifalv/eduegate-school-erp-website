...
export function WhyEduegateSection() {
  return (
    <section className="bg-gradient-to-b from-white to-blue-100 py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center w-full">
          <div className="w-full sm:w-80 lg:w-96 h-48 sm:h-60 rounded-lg shadow-lg overflow-hidden flex-shrink-0">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-10 items-center w-full">
          ...
          <div className="w-full sm:w-80 lg:w-96 h-48 sm:h-80 rounded-lg shadow-lg overflow-hidden flex-shrink-0">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center w-full">
          <div className="w-full sm:w-80 lg:w-96 relative flex-shrink-0">
            <div className="relative h-48 sm:h-72">
              <img src={imgGroup781} alt="Group78" className="w-full h-48 sm:h-52 rounded-lg shadow-lg object-cover" />
              <img src={imgStudentDetails11} alt="Student Details" className="absolute w-48 sm:w-64 h-48 sm:h-56 rounded-lg shadow-lg object-cover left-20 sm:left-32 top-8 sm:top-14" />
            </div>
          </div>
          <div className="flex-1 flex flex-col gap-5">
            <div>
            ...
            <div className="space-y-3">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-9">
                <div className="flex items-center gap-2">
                  <ul className="list-disc text-sm sm:text-base text-gray-700 font-medium ml-6">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-10 items-center w-full">
          <div className="flex-1 flex flex-col gap-5">
            ...
            <div className="space-y-3 text-sm sm:text-base text-gray-700 font-medium">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center w-full">
          <div className="w-full sm:w-80 lg:w-96 h-48 sm:h-72 rounded-lg shadow-lg overflow-hidden flex-shrink-0">
